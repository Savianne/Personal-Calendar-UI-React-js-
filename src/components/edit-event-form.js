...
//Controller
import getEventById from '../controller/get-event-by-id';

const EDIT_EVENT_FORM = ({state}) => {
    ...
    useState(() => {
            // getEventById()
            // setTitle('Bith day');
            // setEventDate(new Date(1998, 8, 3));
    ...
    <Backdrop
       ...
       <LocalizationProvider dateAdapter={AdapterDateFns}>
            <Paper elevation={0} sx={{display: 'flex', flexWrap: 'wrap', flex: '0 1 350px', padding: '0px 20px 20px 20px'}}>
                <h4 style={{width: '100%'}}>Edit Event</h4>
                <Stack spacing={3} sx={{width: '100%'}}>
                    ...
                    <Box sx={{
                        ...
                        <Stack spacing={2} direction="row" sx={{marginTop: '30px', marginLeft: 'auto'}}>
                            <Button variant="text"
                            onClick={() => {
                                dispatcher({type: 'CLOSE_EDIT_EVENT_FORM'})
                            }}>Cancel</Button>
                            ...
                            loading={isLoading}
                            loadingPosition="start">Done</LoadingButton>
                        </Stack>
                    </Box>
                </Stack>
            </Paper>
...
export default EDIT_EVENT_FORM;